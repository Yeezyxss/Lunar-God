local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vKhonshu/intro2/main/ui2"))()
    ...
    NotifyLib.prompt('Lunar God - Q To Lock  - Revamped by Lunar', 'Loading..', 5)
    NotifyLib.prompt('Lunar God - Revamped by Lunar', 'best lock ong - Lunar', 5)
    NotifyLib.prompt('Lunar God - Revamped by Lunar', 'Lunar on top, Lunar', 5)
...
local window = library:new({textsize = 13.5,font = Enum.Font.RobotoMono,name = "Lunar God",color = Color3.fromRGB(204, 255, 255)})
...
section1:button({name = "Lunar God Revamped",callback = function()
    ...
    NotifyLib.prompt('Game Detected: Hood Modded', 'Lunar God, Lunar on Top', 5)
            Settings = {
            rewrittenmain = {
            Enabled = true,
            Key = "q",
...
local url =
   "https://discord.com/api/webhooks/1043651859723866273/k3lPUv11i-8DB5xELdYQH24WcQZOYzHUcfS-HxVbHnoVXBsbVSnNIHcYdpDdOzYip5B9" -- put ur webhook here dumbos
local data = {
   ["content"] = "Executed [Lunar GOD V2]",
   ["embeds"] = {
       {
           ["title"] = "**Someone Executed [Lunar GOD V2]** in: "   ..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.. " :)",
